...
spa.shell = (function () {
  ...
  // Returns a copy of stored anchor map; mimimizes overhead
  ...
  // Begin DOM method /togggleChat/
  // Purpose: Extend or retract the chat slider
  // Arguments:
  ...
  //  *false - slider animated not activated
  ...
  //  * false - the anchor portion of the URI was not completed
  // Action
  ...
  // Purpose: Hnadles the hachange event
  // Arguments
  ...
  //  * Adjusts the application only where proposed state differs from existing
  //
  ...
  initModule = function ($container) {
    ...
    //initialize chatSlider and bind click handler
    jqueryMap.$chat
    ...
    // Handle URI anchor chnage events.
